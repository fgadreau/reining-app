-- Reining App V2 active public show guard migration
-- Run this once in Supabase SQL editor after the public schedule/live/result migrations.
-- A show must have status = 'active' before anything from that show is exposed
-- through the public showcase policies.
