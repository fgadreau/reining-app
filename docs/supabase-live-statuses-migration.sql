-- Reining App V2 public live statuses migration
-- Run this once in Supabase SQL editor for existing projects.
-- This adds arena labels and supports multiple public live statuses:
-- live_no_score, live_scoring, and live_finished.
