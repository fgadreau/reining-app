      ...
      <div style={formGridStyle}>
        <label style={labelStyle}>
          ...
          <input
            ...
            placeholder="ws://127.0.0.1:9875/ws/producer"
            style={inputStyle}
          />
        </label>
        <label style={labelStyle}>
...
const sectionTitleStyle = { display: "block", margin: "3px 0", color: "var(--ss-text, #0f172a)", fontSize: 22, fontWeight: 900 };
...
const inputStyle = { width: "100%", padding: "11px 12px", border: "1px solid #cbd5e1", borderRadius: 9, background: "#fff", color: "var(--ss-text, #0f172a)", fontSize: 15 };
...
const statusLabelStyle = { display: "block", marginBottom: 5, color: "var(--ss-muted, #64748b)", fontSize: 11, fontWeight: 800, textTransform: "uppercase" };
const statusValueStyle = { color: "var(--ss-text, #0f172a)", fontSize: 18 };
const urlRowStyle = { display: "flex", alignItems: "center", gap: 10, padding: 10, borderRadius: 10, background: "var(--ss-primary, #0f172a)" };
...
const tvLinksTitleStyle = { color: "var(--ss-text, #0f172a)", fontSize: 14 };
...
const secondaryButtonStyle = { padding: "9px 13px", border: "1px solid #94a3b8", borderRadius: 9, background: "#fff", color: "var(--ss-text, #0f172a)", fontWeight: 800, cursor: "pointer" };
const helperStyle = { marginTop: 8, color: "var(--ss-muted, #64748b)", fontSize: 13, lineHeight: 1.45 };
