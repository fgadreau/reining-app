export const translations = {
  fr: {
    ...
    analytics: {
      ...
      activityTrend: "Activité par jour",
      actor: "Utilisateur",
      analytics: "Analytics",
      ...
      latestEvent: "Dernier signal",
      loading: "Chargement des analytics...",
      managementViews: "Vues gestion",
      pageViews: "Pages vues",
      pageCategories: "Répartition des vues",
      pageCategoriesMap: {
        app: "Application",
        association_management: "Gestion association",
        class_setup: "Setup de bloc",
        public_association: "Association publique",
        public_directory: "Vitrine publique",
        public_show: "Show public",
        scribe_class: "Saisie scribe",
        show_management: "Gestion de show",
        unknown: "Non classé",
      },
      path: "Page",
      period: "Période",
      ...
      refresh: "Rafraîchir",
      scribeViews: "Vues scribe",
      search: "Recherche",
      searchPlaceholder: "Page, action, utilisateur, show, bloc...",
      showingEvents: "{{count}} événements affichés",
      show: "Show",
      subtitle: "{{count}} événements affichés sur {{total}}.",
      technicalContext: "Langues et fuseaux",
      title: "Analytics",
      topAssociations: "Associations actives",
      topClasses: "Blocs actifs",
      topEvents: "Événements fréquents",
      topPages: "Pages populaires",
      topShows: "Shows actifs",
      trendMeta: "{{views}} vues · {{actions}} actions",
      type: "Type",
      class: "Bloc",
    ...
    adminAccess: {
      accessDenied: "Cette page est réservée aux admins généraux.",
      add: "Ajouter",
      addRole: "Ajouter un rôle",
      association: "Association",
      eyebrow: "Admin",
      loading: "Chargement des accès...",
      missingSelection: "Sélectionne un utilisateur, une association et un rôle.",
      noProfiles: "Aucun profil trouvé.",
      noRoles: "Aucun rôle.",
      refresh: "Rafraîchir",
      remove: "Retirer",
      removeConfirm: "Retirer le rôle {{role}} pour {{association}} ?",
      role: "Rôle",
      roleAddFailed: "Impossible d’ajouter ce rôle.",
      roleAdded: "Rôle ajouté.",
      roleCount: "Rôles: {{count}}",
      roleRemoved: "Rôle retiré.",
      search: "Rechercher",
      searchLabel: "Recherche utilisateur",
      searchPlaceholder: "Nom ou courriel",
      subtitle: "{{profiles}} profils · {{roles}} rôles",
      supabaseOnly: "La gestion globale des accès nécessite Supabase.",
    ...
    common: {
      ...
      localFirstSyncLocal:
        "Sauvé localement. La sync cloud se fera quand Supabase sera disponible.",
      loading: "Chargement...",
      public: "Public",
      saveFailed: "Impossible d'enregistrer. {{message}}",
      deleteFailed: "Impossible de supprimer. {{message}}",
      share: "Partager",
    ...
    championship: {
      ...
      occurrence: {
        ...
        entries: "Entrées",
        entriesSummary: "{{shown}} montrés / {{entries}} entrées",
        go: "Go",
        goLabel: "Type {{type}} · Go {{number}}",
        goNumberLabel: "Go {{number}}",
        goTypeLabel: "Type {{type}}",
        horse: "Cheval",
        noResults: "Aucun détail importé pour cette occurrence.",
        points: "Pts",
        rank: "Rang",
        resultCount: "{{count}} résultats",
        rider: "Cavalier",
        rowSource: "{{file}} · ligne {{row}}",
        rowSourceNumber: "Ligne {{row}}",
        score: "Score",
        show: "Show",
        source: "Source",
        sourceClass: "Classe source",
        sourceFilesSummary: "{{first}} + {{count}} autres",
        sourceRow: "Source",
        title: "Détail de l’occurrence",
      },
      verification: {
        chooseClass: "Choisir une classe",
        class: "Classe",
        close: "Fermer",
        currentStanding: "Classement actuel trouvé",
        eyebrow: "Vérification",
        explanation: "Courte explication",
        fullSeason: "Saison complète",
        help:
          "La demande reste ouverte pendant que tu consultes le championnat. Les détails seront envoyés aux admins de l’association.",
        horse: "Cheval",
        noShows: "Aucune occurrence disponible pour cette classe.",
        open: "Demander une vérification",
        requesterEmail: "Courriel de contact",
        requesterName: "Nom du demandeur",
        requiredFields: "Remplis tous les champs obligatoires.",
        rider: "Cavalier",
        scope: "Show concerné",
        selectedShows: "Un ou plusieurs shows",
        sendFailed:
          "Impossible d’envoyer la demande. Réessaie plus tard ou contacte l’association.",
        sending: "Envoi en cours...",
        sent: "Demande envoyée aux admins de l’association.",
      ...
      admin: {
        ...
        duplicateExisting: "Résultat déjà présent",
        duplicateKeepExisting: "Garder l’existant",
        duplicateKeepFirst: "Garder la première occurrence",
        ...
        duplicateRows: "Doublons détectés",
        duplicateUseLast: "Utiliser la dernière occurrence",
        duplicateUseNew: "Utiliser le nouvel import",
        dqAdd: "Ajouter la DQ",
        dqChooseClass: "Choisir une classe",
        ...
        dqReasonRequired: "La raison de la disqualification est obligatoire.",
        dqRemove: "Retirer la DQ",
        dqRemoved: "DQ retirée et championnat enregistré.",
        dqSaved: "DQ ajoutée et championnat enregistré.",
        dqSelectResultRequired:
          "Choisis une classe, une occurrence et une équipe à disqualifier.",
        dqSaving: "Enregistrement...",
        dqTeam: "Équipe",
        ...
        importedFiles: "Fichiers CSV",
        loading: "Chargement du championnat...",
        markFinal: "Marquer final",
        ...
        pointsExplanationHelp:
          "Explique la méthode de calcul, les égalités, les exclusions ou toute règle particulière.",
        pointsExplanationPlaceholder:
          "Ex. Les points sont attribués selon le classement de chaque occurrence...",
        preview: "Aperçu du classement",
        publicLabel: "Libellé public",
        publicLabels: "Ordre et libellés publics des occurrences",
        publicLabelsHelp:
          "Choisis l’ordre des colonnes et renomme les shows techniques pour la vitrine. Les clés techniques restent inchangées.",
        publicOrder: "Ordre",
        publicLink: "Voir la page publique",
        publish: "Publier provisoire",
        ...
        rulesStatementHelp:
          "Présente les conditions d’admissibilité et les règles générales aux participants.",
        rulesStatementPlaceholder:
      ...
      public: {
        associationCardMeta: "{{classes}} classes · {{events}} occurrences",
        allClasses: "Toutes les classes",
        back: "← Vitrine association",
        classFilter: "Filtrer par classe",
        classMeta: "{{events}} occurrences · {{teams}} duos cheval-cavalier classés",
        classes: "Classes",
        clearSearch: "Effacer",
        description:
          "Classement du championnat de saison publié par {{associationName}}.",
        downloadPdf: "Télécharger PDF",
        downloadPdfFailed: "Impossible de générer le PDF du championnat.",
        empty: "Aucun championnat publié pour cette association.",
        eventTotals: "TOTAL",
        eventCount: "{{count}} occurrences",
        events: "Occurrences",
        eyebrow: "Championnat",
        funFactsClassCount: "{{count}} participations à des classes",
        funFactsClassCountOne: "1 participation à une classe",
        funFactsClose: "Fermer",
        funFactsEyebrow: "Juste pour le fun",
        funFactsActiveMeta: "Participations à des classes, pas nécessairement des passages distincts dans le manège",
        funFactsAllClassesAndTeams: "Toutes classes et duos cheval-cavalier confondus ; classes comptées séparément",
        funFactsBestProgression: "Meilleure progression",
        funFactsProgressionReining: "Meilleure progression — Reining",
        funFactsProgressionRanchRiding: "Meilleure progression — Ranch Riding",
        estimatedPerJudge: "Moyenne estimée par juge",
        ...
        funFactsMostClasses: "Le duo le plus actif",
        funFactsMostPodiums: "Le plus de top 3",
        funFactsOpen: "Faits saillants de la saison",
        funFactsPodiumCount: "{{count}} top 3",
        funFactsPodiumCountOne: "1 top 3",
        funFactsProgressionMeta: "Moy. 2 premiers {{first}} · 2 derniers {{last}}",
        funFactsTitle: "Faits saillants de la saison",
        highlightsSubtitle: "Découvrez la saison en chiffres et les performances marquantes",
        uniqueRiders: "Cavaliers uniques",
        uniqueHorses: "Chevaux uniques",
        uniqueDuos: "Duos cheval-cavalier uniques",
        combinedPointLeaders: "Le plus de points",
        combinedPointLeaderRoles: "Cavalier · Cheval · Duo",
        champion: "Champion",
        coChampion: "Co-champion",
        reserveChampion: "Réserve Champion",
        coReserveChampion: "Co-réserve Champion",
        funFactsTopHorsePoints: "Le plus de points · Cheval",
        funFactsTopRiderPoints: "Le plus de points · Cavalier",
        funFactsTopTeamPoints: "Le plus de points · Duo",
        funFactsWithHorse: "avec",
        includedShows: "Shows inclus",
        includedShowCount: "{{count}} shows inclus",
        loading: "Chargement du championnat...",
        mobileNoOccurrences: "Aucune occurrence classée.",
        mobileOccurrences: "Occurrences classées",
        moreActions: "Plus",
        noIncludedShows: "Aucun show inclus.",
        noSearchResults: "Aucun classement ne correspond à cette recherche.",
        placeScore: "Pl. {{place}} · Score {{score}}",
        pointsExplanationTitle: "Calcul des points",
        rank: "Rang",
        rulesClose: "Fermer",
        rulesEyebrow: "Championnat",
        rulesOpen: "Règles et calcul des points",
        rulesHide: "Masquer",
        rulesStatementTitle: "Règles du championnat",
        rulesTitle: "Fonctionnement du championnat",
        rulesUnavailable:
          "Les règles et le calcul des points n’ont pas encore été publiés.",
        rulesView: "Voir",
        searchLabel: "Rechercher dans le championnat",
        searchPlaceholder: "Classe, cavalier ou cheval",
        showCount: "{{count}} shows",
        shows: "Shows",
        teams: "Duos cheval-cavalier",
        teamsCount: "Duos cheval-cavalier : {{count}}",
        title: "Championnat de saison",
        totalPoints: "Pts total",
        updated: "Mise à jour",
        viewChampionship: "Voir le championnat",
      },
    },
    freshness: {
      current: "À jour · {{age}}",
    ...
    presentation: {
      closingText:
        "ShowScore reste léger à utiliser, mais assez complet pour gérer un show en direct.",
      closingTitle: "Un outil de concours, pas une page de plus à gérer",
      disciplines: {
        huntSeatEquitation: "Hunt Seat Equitation",
        ranchRiding: "Ranch Riding",
        ranchTrail: "Ranch Trail",
        reining: "Reining",
        showmanship: "Showmanship",
        trail: "Trail",
        westernHorsemanship: "Western Horsemanship",
        westernRiding: "Western Riding",
        workingTrack: "Disciplines de travail en piste",
      },
      ...
      managementCta: "Espace gestion",
      pillars: {
        live: {
          title: "Pointage live",
          text: "Le show peut être suivi pendant qu’il se déroule: en piste, en attente, dernier score et résultats publiés.",
        },
        scribe: {
          title: "Scribe d’abord",
          text: "La saisie reste courte, claire et adaptée à une table de pointage occupée.",
        },
        showground: {
          title: "Wifi instable prévu",
          text: "L’app garde une base locale et synchronise avec le cloud quand la connexion le permet.",
        },
      },
      publicCta: "Voir la vitrine publique",
      subtitle:
        "Une application sobre pour scorer, suivre et publier un show sans compliquer l’accès aux visiteurs.",
      title: "ShowScore relie la table de pointage et la vitrine publique",
      workflow: {
        prepare: {
          title: "Préparer",
          text: "Créer le show, les journées, les blocs et importer les draws.",
        },
        score: {
          title: "Scorer",
          text: "Le scribe entre les manoeuvres et le secrétariat garde le suivi.",
        },
        publish: {
          title: "Publier",
          text: "La vitrine affiche le live, les résultats et le livestream autorisé.",
        },
      },
      workflowEyebrow: "Flux de travail",
      workflowText:
        "La structure reste simple: association, show, blocs, puis divisions/classes seulement quand les résultats en ont besoin.",
      workflowTitle: "Du draw au résultat public",
    },
    language: {
      english: "English",
      french: "Français",
    ...
    management: {
      announcer: {
        ...
        offline: "Hors ligne",
        localRelayAddress: "Adresse du relais sur ce Chromebook",
        localRelayConnection: "Relais local",
        localRelayCopied: "Copié",
        localRelayCopy: "Copier l’adresse OBS",
        localRelayCopyGeneric: "Copier",
        localRelayDisable: "Désactiver",
        localRelayEnable: "Configurer",
        localRelayEyebrow: "Mode hors ligne",
        localRelayHelp:
          "Lance le relais dans Linux sur ce Chromebook, puis entre le code affiché dans son terminal. Dans OBS, utilise l’adresse réseau affichée ici.",
        localRelayIntro:
          "Garde l’overlay OBS et les écrans TV à jour sur le réseau local, même si Internet coupe.",
        localRelayObs: "Écrans OBS connectés",
        localRelayTv: "Écrans TV connectés",
        localRelayTvArena: "Manège · {{arena}}",
        localRelayTvCompetition: "Compétition · {{arena}}",
        localRelayTvGeneral: "Vue générale",
        localRelayTvStandings: "Classement général",
        localRelayTvStandingsArena: "Classement · {{arena}}",
        localRelayTvLinks: "Vues TV locales",
        localRelayPairingCode: "Code de jumelage",
        localRelayPending: "Changements à synchroniser",
        localRelayReconnect: "Reconnecter",
        localRelayTitle: "Relais réseau local",
        localRelayStatus_disabled: "Désactivé",
        localRelayStatus_disconnected: "Déconnecté",
        localRelayStatus_connecting: "Connexion…",
        localRelayStatus_connected: "Connecté",
        localRelayStatus_error: "Erreur",
        announceHalfTime: "Annonce: moitié du temps",
        announceOneMinute: "Annonce: il reste 1 minute",
        close: "Fermer",
        completeBlocked:
          "Impossible de terminer : {{reviews}} révision(s) vidéo et {{unresolved}} run(s) non réglé(s).",
        correctResult: "Corriger un résultat déjà entendu",
        correctionNote: "Note de correction (facultative)",
        dayCounts:
          "Blocs: {{classCount}} · Paid warm ups: {{warmupCount}}",
        dragAfter: "Drag après {{count}}",
        dragDue: "Drag de surface prévu · {{minutes}} min",
        draw: "Draw",
        enableSoundAlerts: "Activer sons",
        enableMinimalDisplay: "Activer l’ordre seulement",
        enterResult: "Entrer le résultat",
        latestScore: "Dernier concurrent",
        ...
        manualBlockCompleted: "Bloc terminé par l’annonceur",
        ...
        minimalDisplayHelp:
          "Dernier recours : garde le nom du bloc et le numéro d’ordre en piste, mais masque les identités et les pointages dans la diffusion publique.",
        inPreparation: "En attente",
        next: "Prochain",
        noActiveRun: "Aucun run actif.",
        noNextRun: "Aucun prochain run.",
        noScore: "No score",
        noScoreConfirm: "Marquer le concurrent #{{draw}} No score ?",
        noShowOnCourse: "No show en piste",
        ...
        provisionalResultsPdf: "PDF des résultats provisoires",
        provisionalResultsPdfTitle: "Résultats provisoires · annonceur",
        pendingReviews: "Révisions vidéo en attente : {{count}}",
        qualifiedRiders: "Liste des cavaliers classés",
        qualifiedRidersHelp:
          "Top {{count}} de chaque classe, égalités incluses, sans doublons de cavalier.",
        qualifiedRiderTotal: "{{count}} cavalier(s)",
        noQualifiedRiders: "Aucun cavalier classé à afficher.",
        downloadQualifiedRidersPdf: "Télécharger le PDF",
        resetTimer: "Repartir timer",
        restoreFullDisplay: "Rétablir l’affichage complet",
        readyToStart: "En piste · prêt à démarrer",
        runCount: "Runs: {{count}}",
        scratchOnCourse: "Scratch en piste",
        ...
        sourceAnnouncer: "Source : annonceur",
        sourceScribes: "Source : scribes",
        startOnCourse: "Démarrer en piste",
        startDrag: "Démarrer drag",
        startingDrag: "Démarrage du drag…",
        startNext: "Démarrer prochain",
        startingNext: "Mise en piste du prochain concurrent…",
        stats: "Stats",
        stopDrag: "Terminer drag",
        endingDrag: "Fin du drag en cours…",
        stopAndMarkPassed: "Arrêter et marquer passé",
        savingAction: "Enregistrement de l’action…",
        completingClass: "Fermeture du bloc…",
        synced: "Synchronisé",
      ...
      days: {
        ...
        save: "Enregistrer",
        tabsLabel: "Changer de journée du show",
        title: "Journées",
        venueFallback: "Lieu",
      },
      classes: {
      ...
      scoring: {
        ...
        addManualPenalty: "Ajouter pénalité",
        clearManualPenaltyInput: "Vider",
        clearManeuverPenalty: "Effacer dernière pénalité",
        ...
        manualPenalty: "Pénalité manuelle",
      ...
      classSetup: {
        ...
        importSummaryScratched: "Scratched",
        importSummaryTitle: "Résumé de l’import draw",
        importSummaryUnnamedClass: "Nom de classe non détecté",
        ...
        liveDataSourceHelp:
          "Cette source alimente la vitrine live, l’affiche TV, l’overlay OBS et le tableau annonceur. Une seule source est active à la fois.",
        liveDataSourceScribe: "Scribes · pointage détaillé",
        ...
        qualifiedRiderCount: "Cavaliers classés par classe",
        qualifiedRiderCountHelp:
          "À la fin du bloc, prend les X premiers de chaque classe, inclut les égalités au dernier rang et retire les cavaliers en double.",
      ...
      secretariat: {
        ...
        judgeSheetDetails: "Détails des feuilles ({{count}})",
      ...
      schedulePreview: {
        accessDenied: "Ce rôle n’a pas accès à l’aperçu horaire.",
        dayEnd: "Fin prévue",
        draftOnly: "Brouillon interne, non publié",
        draw: "Draw",
        drawCount: "{{count}} runs",
        drawPending: "Draw à venir",
        empty: "Aucun bloc ou paid warm up à afficher dans l’horaire.",
        estimatedDuration: "Durée estimée",
        estimatedStart: "Début estimé",
        estimateSource: "Estimation",
        eyebrow: "Aperçu horaire",
        item: "Classe / warm up",
        itemCount: "{{count}} éléments",
        loading: "Chargement de l’horaire...",
        measuredAverage: "moyenne mesurée",
        needsDuration: "durée à estimer",
        needsFixedStart: "départ à confirmer",
        order: "Ordre",
        patternAverage: "moyenne pattern",
        plannedStart: "Départ demandé",
        publicEnabled: "Publié sur la vitrine",
        riderCount: "{{count}} cavaliers",
        subtitle:
          "Tableau informatif à vérifier avant publication sur la vitrine publique.",
        toConfirm: "À confirmer",
        type: "Type",
        warmupDuration: "durée warm up",
      },
      shows: {
        accessDenied: "Ce rôle n’a pas accès à cette association.",
        accessLabel: "Accès",
        accessLoading: "chargement...",
        activateShow: "Activer le show",
        activateShowConfirm:
          "Activer ce show ? Les contenus publics déjà activés pourront apparaître dans la vitrine.",
        addShow: "+ Ajouter un show",
        associationNotFound: "Association introuvable.",
        backAssociations: "← Retour à la liste d’associations",
        cancel: "Annuler",
        dateRangeJoin: "au",
        dateTbd: "Dates à confirmer",
        delete: "Supprimer",
        ...
        copyTvDisplayArenaLink: "Copier lien",
        ...
        newSponsorLevel: "Nouveau niveau {{number}}",
        noSponsorLogos: "Aucun logo commanditaire ajouté.",
        noSponsorLogosInLevel: "Aucun logo dans ce niveau.",
        ...
        overlaySponsorLogosHelp:
          "Ces logos sont sauvegardés sur l’association et réutilisés dans tous ses overlays OBS. Les nouveaux fichiers sont compressés automatiquement.",
        overlaySponsorLogosTitle: "Commanditaires de l’association",
        ...
        publicScheduleTitle: "Horaire public",
        publicShowcaseBlocked: "Vitrine bloquée",
        publicShowcaseBlockedBadge: "Draft",
        publicShowcaseBlockedHelp:
          "Le show n’est pas actif: rien de ce show ne sort dans la vitrine publique.",
        publicShowcaseCount: "{{count}}",
        publicShowcaseLivestream: "Vidéo",
        publicShowcaseLive: "Live",
        publicShowcaseNo: "Non",
        publicShowcaseOpen: "Ouvrir la vitrine",
        publicShowcasePartial: "À préparer",
        publicShowcasePartialBadge: "À vérifier",
        publicShowcasePartialHelp:
          "Le show est actif, mais aucun horaire, live, livestream, scoresheet ou résultat n’est visible pour l’instant.",
        publicShowcaseReady: "Vitrine visible",
        publicShowcaseReadyBadge: "Visible",
        publicShowcaseReadyHelp:
          "La vitrine a du contenu public visible pour les visiteurs.",
        publicShowcaseResults: "Résultats",
        publicShowcaseSchedule: "Horaire",
        publicShowcaseScoresheets: "Scoresheets",
        publicShowcaseShowActive: "Show actif",
        publicShowcaseStatus: "État vitrine publique",
        publicShowcaseYes: "Oui",
        removeSponsorLogo: "Retirer",
        removeSponsorLevel: "Supprimer le niveau",
        removeSponsorLevelConfirm:
          "Supprimer ce niveau et tous les logos qu’il contient ?",
        save: "Enregistrer",
        schedulePublicEnabled: "Horaire public activé",
        showSchedule: "Aperçu horaire",
        saving: "Enregistrement...",
        sponsorLogo: "Logo commanditaire",
        sponsorLevelFallback: "Niveau sans nom",
        sponsorLevelName: "Nom du niveau (ex. Argent)",
        sponsorLogosOptimizeFailed:
          "Impossible d’optimiser les logos commanditaires. {{message}}",
        sponsorLogosOptimizing: "Optimisation des logos...",
        sponsorName: "Nom du commanditaire",
        ...
        statusLabel: "Statut",
        statusPrefix: "Statut",
        tvDisplayArenaTitle: "Liens par autre manège",
        tvDisplayCompetitionBadge: "Manège de compétition seulement",
        tvDisplayCompetitionEyebrow: "Affichage dédié",
        tvDisplayCompetitionLinkHint:
          "Choisis d’abord le manège de compétition pour générer son lien dédié.",
        tvDisplayCompetitionLinkTitle:
          "Lien dédié à ouvrir sur l’écran de compétition",
        tvDisplayCompetitionSaveHint:
          "Ajoute la vidéo puis enregistre les réglages pour activer ce lien.",
        tvDisplayGeneralTitle: "Lien général — autres écrans",
        tvDisplayHelp:
          "À utiliser partout sauf dans le manège de compétition. Ces écrans montrent le live, les prochains passages, les derniers résultats et les commanditaires.",
        tvDisplayMessageEnLabel: "Message pause EN",
        tvDisplayMessageEnPlaceholder: "Live will be back soon",
        tvDisplayMessageFrLabel: "Message pause FR",
        tvDisplayMessageFrPlaceholder: "Live de retour bientôt",
        tvDisplayPausedLabel: "Mettre seulement les écrans généraux en pause",
        tvDisplayPrompt: "Lien écran TV à ouvrir sur la télévision",
        tvDisplayShortCode: "Code TV",
        tvDisplayTitle: "Affichage TV général — autres écrans",
        tvDisplayVideoArenaLabel: "Manège de compétition",
        ...
        tvDisplayVideoHelp:
          "Cet écran est réservé au manège de compétition. La vidéo joue en boucle avec les données live dans une bande dessous; aucun commanditaire supplémentaire n’est affiché.",
        ...
        copyTvDisplayStandings: "Copier le lien classement",
        openTvDisplayCompetition: "Ouvrir l’écran de compétition",
        openTvDisplayStandings: "Ouvrir l’écran classement",
        copyTvDisplayCompetition: "Copier le lien dédié",
        tvDisplayStandingsTitle: "Classements en boucle — bloc en cours",
    ...
    public: {
      ...
      tv: {
        ...
        pauseDefaultMessage: "Live de retour bientôt",
      },
      results: {
        arena: "Manège",
        back: "← Retour",
        ...
        dragPlanned: "Drag de surface prévu · {{minutes}} min",
        ...
        nextScheduleEstimatedStart: "Heure estimée: {{date}} à {{time}}",
        nextScheduleFixedStart: "Heure définie: {{date}} à {{time}}",
        nextScheduleItem: "Prochain bloc",
        nextScheduleUnknownStart: "Heure à confirmer",
        nextScheduleUnknownStartOnDate: "{{date}} · heure à confirmer",
        ...
        publishedSheetsCount: "{{count}} scoresheet(s)",
  ...
  en: {
    ...
    analytics: {
      ...
      refresh: "Refresh",
      scribeViews: "Scribe views",
      search: "Search",
      searchPlaceholder: "Page, action, user, show, block...",
      showingEvents: "{{count}} events shown",
      show: "Show",
      subtitle: "{{count}} events shown out of {{total}}.",
      technicalContext: "Languages and time zones",
      title: "Analytics",
      topAssociations: "Active associations",
      topClasses: "Active blocks",
      topEvents: "Frequent events",
      topPages: "Popular pages",
      topShows: "Active shows",
      trendMeta: "{{views}} views · {{actions}} actions",
      type: "Type",
      class: "Block",
    ...
    adminAccess: {
      accessDenied: "This page is reserved for platform admins.",
      add: "Add",
      addRole: "Add role",
      association: "Association",
      eyebrow: "Admin",
      loading: "Loading access...",
      missingSelection: "Select a user, association, and role.",
      noProfiles: "No profile found.",
      noRoles: "No role.",
      refresh: "Refresh",
      remove: "Remove",
      removeConfirm: "Remove the {{role}} role for {{association}}?",
      role: "Role",
      roleAddFailed: "Unable to add this role.",
      ...
      subtitle: "{{profiles}} profiles · {{roles}} roles",
      supabaseOnly: "Global access management requires Supabase.",
    ...
    common: {
      ...
      localFirstSyncLocal:
        "Saved locally. Cloud sync will happen when Supabase is available.",
      loading: "Loading...",
      public: "Public",
    ...
    championship: {
      ...
      occurrence: {
        ...
        close: "Close",
        completeBlocked:
          "Cannot complete: {{reviews}} video review(s) and {{unresolved}} unresolved run(s).",
        correctResult: "Correct a previously heard result",
        ...
        disqualifiedShort: "DQ",
        entries: "Entries",
        entriesSummary: "{{shown}} shown / {{entries}} entries",
        go: "Go",
        goLabel: "Type {{type}} · Go {{number}}",
        goNumberLabel: "Go {{number}}",
        goTypeLabel: "Type {{type}}",
        horse: "Horse",
        noResults: "No imported detail for this occurrence.",
        points: "Pts",
        rank: "Rank",
        resultCount: "{{count}} results",
        rider: "Rider",
        rowSource: "{{file}} · row {{row}}",
        rowSourceNumber: "Row {{row}}",
        score: "Score",
        show: "Show",
        source: "Source",
        sourceClass: "Source class",
        sourceFilesSummary: "{{first}} + {{count}} more",
        sourceRow: "Source",
      ...
      verification: {
        ...
        class: "Class",
        close: "Close",
        currentStanding: "Current standing found",
        eyebrow: "Verification",
        explanation: "Short explanation",
        fullSeason: "Full season",
        help:
          "The request stays open while you review the championship. Details will be emailed to the association admins.",
        horse: "Horse",
        noShows: "No occurrence is available for this class.",
        ...
        rider: "Rider",
        scope: "Related show",
        selectedShows: "One or more shows",
        sendFailed:
          "Unable to send the request. Try again later or contact the association.",
        sending: "Sending...",
        sent: "Request sent to the association admins.",
        submit: "Send request",
        supabaseUnavailable:
      ...
      admin: {
        ...
        duplicateExisting: "Existing result",
        duplicateKeepExisting: "Keep existing",
        duplicateKeepFirst: "Keep first occurrence",
        duplicateModalAppendHelp:
        ...
        duplicateRows: "Detected duplicates",
        duplicateUseLast: "Use last occurrence",
        duplicateUseNew: "Use new import",
        dqAdd: "Add DQ",
        dqChooseClass: "Choose a class",
        ...
        dqReasonRequired: "The disqualification reason is required.",
        dqRemove: "Remove DQ",
        dqRemoved: "DQ removed and championship saved.",
        dqSaved: "DQ added and championship saved.",
        dqSelectResultRequired:
          "Choose a class, an occurrence, and a team to disqualify.",
        dqSaving: "Saving...",
        dqTeam: "Team",
        ...
        pointsExplanationHelp:
          "Explain the calculation method, ties, exclusions, and any special rules.",
        pointsExplanationPlaceholder:
          "Example: Points are awarded according to each occurrence ranking...",
        preview: "Standings preview",
        publicLabel: "Public label",
        publicLabels: "Public occurrence order and labels",
        publicLabelsHelp:
          "Choose the column order and rename technical shows for the showcase. Technical keys stay unchanged.",
        publicOrder: "Order",
        publicLink: "View public page",
        publish: "Publish provisional",
        removeImport: "Remove",
        removeImportConfirm:
        ...
        rulesStatementHelp:
          "Present eligibility requirements and general rules to participants.",
        rulesStatementPlaceholder:
      ...
      public: {
        ...
        back: "← Association showcase",
        classFilter: "Filter by class",
        classMeta: "{{events}} occurrences · {{teams}} ranked horse–rider duos",
        classes: "Classes",
        clearSearch: "Clear",
        description:
          "Season championship standings published by {{associationName}}.",
        downloadPdf: "Download PDF",
        downloadPdfFailed: "Unable to generate the championship PDF.",
        empty: "No championship has been published for this association.",
        eventTotals: "TOTAL",
        eventCount: "{{count}} occurrences",
        events: "Occurrences",
        eyebrow: "Championship",
        funFactsClassCount: "{{count}} class participations",
        funFactsClassCountOne: "1 class participation",
        funFactsClose: "Close",
        funFactsEyebrow: "Just for fun",
        funFactsActiveMeta: "Class participations, not necessarily separate arena runs",
        funFactsAllClassesAndTeams: "Across all classes and horse–rider duos; classes counted separately",
        funFactsBestProgression: "Best improvement",
        funFactsProgressionReining: "Best improvement — Reining",
        funFactsProgressionRanchRiding: "Best improvement — Ranch Riding",
        estimatedPerJudge: "Estimated average per judge",
        ...
        funFactsMostClasses: "Most active duo",
        funFactsMostPodiums: "Most top 3 finishes",
        funFactsOpen: "Season highlights",
        funFactsPodiumCount: "{{count}} top 3 placings",
        funFactsPodiumCountOne: "1 top 3 placing",
        funFactsProgressionMeta: "First 2 avg {{first}} · last 2 {{last}}",
        funFactsTitle: "Season highlights",
        highlightsSubtitle: "Explore the season in numbers and standout performances",
        uniqueRiders: "Unique riders",
        uniqueHorses: "Unique horses",
        uniqueDuos: "Unique horse–rider duos",
        combinedPointLeaders: "Most points",
        combinedPointLeaderRoles: "Rider · Horse · Duo",
        champion: "Champion",
        coChampion: "Co-champion",
        reserveChampion: "Reserve Champion",
        coReserveChampion: "Co-reserve Champion",
        funFactsTopHorsePoints: "Most points · Horse",
        funFactsTopRiderPoints: "Most points · Rider",
        funFactsTopTeamPoints: "Most points · Duo",
        funFactsWithHorse: "with",
        includedShows: "Included shows",
        includedShowCount: "{{count}} included shows",
        loading: "Loading championship...",
        mobileNoOccurrences: "No ranked occurrence.",
        mobileOccurrences: "Ranked occurrences",
        moreActions: "More",
        noIncludedShows: "No included show.",
        noSearchResults: "No standings match this search.",
        placeScore: "Pl. {{place}} · Score {{score}}",
        pointsExplanationTitle: "Points calculation",
        rank: "Rank",
        rulesClose: "Close",
        rulesEyebrow: "Championship",
        rulesOpen: "Rules and points calculation",
        rulesHide: "Hide",
        rulesStatementTitle: "Championship rules",
        rulesTitle: "How the championship works",
        rulesUnavailable:
          "The rules and points calculation have not been published yet.",
        rulesView: "View",
        searchLabel: "Search the championship",
        searchPlaceholder: "Class, rider, or horse",
        showCount: "{{count}} shows",
        shows: "Shows",
        teams: "Horse–rider duos",
        teamsCount: "Horse–rider duos: {{count}}",
        title: "Season championship",
        totalPoints: "Pts total",
        updated: "Updated",
        viewChampionship: "View championship",
      },
    },
    freshness: {
      current: "Current · {{age}}",
    ...
    presentation: {
      closingText:
        "ShowScore stays light to use, but complete enough to run a live show.",
      closingTitle: "A show tool, not one more page to manage",
      disciplines: {
        huntSeatEquitation: "Hunt Seat Equitation",
        ranchRiding: "Ranch Riding",
        ranchTrail: "Ranch Trail",
        ...
        westernHorsemanship: "Western Horsemanship",
        westernRiding: "Western Riding",
        workingTrack: "In-arena working disciplines",
      },
      disciplinesEyebrow: "Disciplines",
      disciplinesText:
      ...
      managementCta: "Management area",
      pillars: {
        live: {
          title: "Live scoring",
          text: "The show can be followed as it happens: in the arena, on deck, latest score, and published results.",
        },
        scribe: {
          title: "Scribe first",
          text: "Entry stays short, clear, and suited to a busy scoring table.",
        },
        showground: {
          title: "Unstable wifi expected",
          text: "The app keeps a local base and syncs with the cloud when the connection allows it.",
        },
      },
      publicCta: "View public showcase",
      subtitle:
        "A sober app to score, follow, and publish a show without complicating visitor access.",
      title: "ShowScore connects the scoring table and the public showcase",
      workflow: {
        prepare: {
          title: "Prepare",
          text: "Create the show, days, blocks, and import draws.",
        },
        score: {
          title: "Score",
          text: "The scribe enters maneuvers while the secretariat keeps control.",
        },
        publish: {
          title: "Publish",
          text: "The showcase displays live status, results, and the authorized livestream.",
        },
      },
      workflowEyebrow: "Workflow",
      workflowText:
        "The structure stays simple: association, show, blocks, then divisions/classes only when results need them.",
      workflowTitle: "From draw to public result",
    },
    language: {
      english: "English",
      french: "Français",
    ...
    management: {
      announcer: {
        ...
        offline: "Offline",
        localRelayAddress: "Relay address on this Chromebook",
        localRelayConnection: "Local relay",
        localRelayCopied: "Copied",
        localRelayCopy: "Copy OBS address",
        localRelayCopyGeneric: "Copy",
        localRelayDisable: "Disable",
        localRelayEnable: "Configure",
        localRelayEyebrow: "Offline mode",
        localRelayHelp:
          "Start the relay in Linux on this Chromebook, then enter the pairing code shown in its terminal. In OBS, use the network address displayed here.",
        localRelayIntro:
          "Keeps the OBS overlay and TV displays current over the local network, even when the Internet drops.",
        localRelayObs: "Connected OBS screens",
        localRelayTv: "Connected TV screens",
        localRelayTvArena: "Arena · {{arena}}",
        localRelayTvCompetition: "Competition · {{arena}}",
        localRelayTvGeneral: "General display",
        localRelayTvStandings: "General standings",
        localRelayTvStandingsArena: "Standings · {{arena}}",
        localRelayTvLinks: "Local TV displays",
        localRelayPairingCode: "Pairing code",
        localRelayPending: "Changes to sync",
        localRelayReconnect: "Reconnect",
        localRelayTitle: "Local network relay",
        localRelayStatus_disabled: "Disabled",
        localRelayStatus_disconnected: "Disconnected",
        localRelayStatus_connecting: "Connecting…",
        localRelayStatus_connected: "Connected",
        localRelayStatus_error: "Error",
        ...
        draw: "Draw",
        enableSoundAlerts: "Enable sounds",
        enableMinimalDisplay: "Enable order only",
        enterResult: "Enter result",
        latestScore: "Last competitor",
        ...
        manualBlockCompleted: "Block completed by announcer",
        manualLiveProvisional:
        ...
        minimalDisplayHelp:
          "Last resort: keeps the block name and on-course order number, but hides identities and scores from public displays.",
        inPreparation: "In the hole",
        next: "Next",
        noActiveRun: "No active run.",
        noNextRun: "No next run.",
        noScore: "No score",
        noScoreConfirm: "Mark competitor #{{draw}} as no score?",
        noShowOnCourse: "No show in arena",
        ...
        provisionalResultsPdf: "Provisional results PDF",
        provisionalResultsPdfTitle: "Provisional results · announcer",
        pendingReviews: "Pending video reviews: {{count}}",
        qualifiedRiders: "Classified rider list",
        qualifiedRidersHelp:
          "Top {{count}} in each class, including ties, with duplicate riders removed.",
        qualifiedRiderTotal: "{{count}} rider(s)",
        noQualifiedRiders: "No classified rider to display.",
        downloadQualifiedRidersPdf: "Download PDF",
        resetTimer: "Restart timer",
        restoreFullDisplay: "Restore full display",
        readyToStart: "In the arena · ready to start",
        runCount: "Runs: {{count}}",
        scratchOnCourse: "Scratch in arena",
        ...
        sourceAnnouncer: "Source: announcer",
        sourceScribes: "Source: scribes",
        startOnCourse: "Start in arena",
        startDrag: "Start drag",
        startingDrag: "Starting drag…",
        startNext: "Start next",
        startingNext: "Putting the next competitor in the arena…",
        stats: "Stats",
        stopDrag: "End drag",
        endingDrag: "Ending drag…",
        stopAndMarkPassed: "Stop and mark done",
        savingAction: "Saving action…",
        completingClass: "Completing block…",
        synced: "Synced",
        syncing: "Syncing…",
      ...
      scoring: {
        ...
        addManualPenalty: "Add penalty",
        clearManualPenaltyInput: "Clear",
        clearManeuverPenalty: "Clear last penalty",
      ...
      classSetup: {
        ...
        importSummaryParticipants: "Participants",
        importSummaryScratched: "Scratched",
        importSummaryTitle: "Draw import summary",
        importSummaryUnnamedClass: "Class name not detected",
        ...
        liveDataSourceHelp:
          "This source feeds the public live showcase, TV display, OBS overlay, and announcer dashboard. Only one source is active at a time.",
        liveDataSourceScribe: "Scribes · detailed scoring",
        ...
        qualifiedRiderCount: "Classified riders per class",
        qualifiedRiderCountHelp:
          "At block completion, takes the top X in each class, includes cutoff ties, and removes duplicate riders.",
      ...
      secretariat: {
        ...
        judgeSheetDetails: "Sheet details ({{count}})",
      ...
      schedulePreview: {
        accessDenied: "This role does not have access to the schedule preview.",
        dayEnd: "Planned finish",
        draftOnly: "Internal draft, not published",
        draw: "Draw",
        drawCount: "{{count}} runs",
        drawPending: "Draw pending",
        empty: "No block or paid warm up to show in the schedule.",
        ...
        needsDuration: "duration to estimate",
        needsFixedStart: "start to confirm",
        order: "Order",
        patternAverage: "pattern average",
        plannedStart: "Requested start",
        publicEnabled: "Published on showcase",
        riderCount: "{{count}} riders",
        subtitle:
          "Informational table to review before publishing on the public showcase.",
      ...
      shows: {
        ...
        activateShowConfirm:
          "Activate this show? Public content that is already enabled may appear on the showcase.",
        addShow: "+ Add show",
        associationNotFound: "Association not found.",
        backAssociations: "← Back to association list",
        cancel: "Cancel",
        dateRangeJoin: "to",
        dateTbd: "Dates to confirm",
        delete: "Delete",
        ...
        copyTvDisplayArenaLink: "Copy link",
        ...
        newSponsorLevel: "New level {{number}}",
        noSponsorLogos: "No sponsor logo added.",
        noSponsorLogosInLevel: "No logo in this level.",
        ...
        overlaySponsorLogosHelp:
          "These logos are saved on the association and reused across all of its OBS overlays. New files are compressed automatically.",
        overlaySponsorLogosTitle: "Association sponsors",
        ...
        publicScheduleTitle: "Public schedule",
        publicShowcaseBlocked: "Showcase blocked",
        publicShowcaseBlockedBadge: "Draft",
        publicShowcaseBlockedHelp:
          "The show is not active: nothing from this show is exposed on the public showcase.",
        publicShowcaseCount: "{{count}}",
        publicShowcaseLivestream: "Video",
        publicShowcaseLive: "Live",
        publicShowcaseNo: "No",
        publicShowcaseOpen: "Open showcase",
        publicShowcasePartial: "To prepare",
        publicShowcasePartialBadge: "Check",
        publicShowcasePartialHelp:
          "The show is active, but no schedule, live feed, livestream, score sheet, or result is visible yet.",
        publicShowcaseReady: "Showcase visible",
        publicShowcaseReadyBadge: "Visible",
        publicShowcaseReadyHelp:
          "The showcase has public content visible to visitors.",
        publicShowcaseResults: "Results",
        publicShowcaseSchedule: "Schedule",
        publicShowcaseScoresheets: "Score sheets",
        publicShowcaseShowActive: "Active show",
        publicShowcaseStatus: "Public showcase status",
        publicShowcaseYes: "Yes",
        removeSponsorLogo: "Remove",
        removeSponsorLevel: "Delete level",
        removeSponsorLevelConfirm:
          "Delete this level and every logo it contains?",
        save: "Save",
        schedulePublicEnabled: "Public schedule enabled",
        showSchedule: "Schedule preview",
        saving: "Saving...",
        sponsorLogo: "Sponsor logo",
        sponsorLevelFallback: "Unnamed level",
        sponsorLevelName: "Level name (for example Silver)",
        sponsorLogosOptimizeFailed:
          "Unable to optimize sponsor logos. {{message}}",
        sponsorLogosOptimizing: "Optimizing logos...",
        sponsorName: "Sponsor name",
        ...
        statusLabel: "Status",
        statusPrefix: "Status",
        tvDisplayArenaTitle: "Links by other arena",
        tvDisplayCompetitionBadge: "Competition arena only",
        tvDisplayCompetitionEyebrow: "Dedicated display",
        tvDisplayCompetitionLinkHint:
          "Select the competition arena first to generate its dedicated link.",
        tvDisplayCompetitionLinkTitle:
          "Dedicated link to open on the competition screen",
        tvDisplayCompetitionSaveHint:
          "Add the video and save the settings to activate this link.",
        tvDisplayGeneralTitle: "General link — other screens",
        tvDisplayHelp:
          "Use this everywhere except the competition arena. These screens show live data, upcoming competitors, recent results, and sponsors.",
        tvDisplayMessageEnLabel: "Pause message EN",
        tvDisplayMessageEnPlaceholder: "Live will be back soon",
        tvDisplayMessageFrLabel: "Pause message FR",
        tvDisplayMessageFrPlaceholder: "Live de retour bientôt",
        tvDisplayPausedLabel: "Pause only the general displays",
        tvDisplayPrompt: "TV display link to open on the television",
        tvDisplayShortCode: "TV code",
        tvDisplayTitle: "General TV display — other screens",
        tvDisplayVideoArenaLabel: "Competition arena",
        ...
        tvDisplayVideoHelp:
          "This screen is reserved for the competition arena. The video loops with live data in a strip below it and no additional sponsor rail.",
        ...
        copyTvDisplayStandings: "Copy standings link",
        openTvDisplayCompetition: "Open competition screen",
        openTvDisplayStandings: "Open standings screen",
        copyTvDisplayCompetition: "Copy dedicated link",
        tvDisplayStandingsTitle: "Rotating standings — current block",
    ...
    public: {
      ...
      tv: {
        ...
        judge: "Judge",
        paidWarmup: "Paid warm up",
        pauseDefaultMessage: "Live will be back soon",
      },
      results: {
        arena: "Arena",
        back: "← Back",
        ...
        dragPlanned: "Ground drag planned · {{minutes}} min",
        ...
        nextScheduleEstimatedStart: "Estimated time: {{date}} at {{time}}",
        nextScheduleFixedStart: "Set time: {{date}} at {{time}}",
        nextScheduleItem: "Next block",
        nextScheduleUnknownStart: "Time to confirm",
        nextScheduleUnknownStartOnDate: "{{date}} · time to confirm",
        ...
        publishedSheetsCount: "{{count}} score sheet(s)",
        publishedSheets: "blocks with published sheets",
        rank: "Rank",
        registeredClasses: "Entered classes",
        participantCount: "{{count}} participants",
        passedWithScores: "Completed with scores",
