  ...
  fr: {
    ...
    championship: {
      ...
      admin: {
        ...
        publicLabels: "Libellés publics des occurrences",
        publicLabelsHelp:
          "Renomme les shows techniques pour la vitrine, par exemple AQR MAY SHOW 1 vers Mai 1. Les clés techniques restent inchangées.",
  ...
  en: {
    ...
    championship: {
      ...
      admin: {
        ...
        publicLabels: "Public occurrence labels",
        publicLabelsHelp:
          "Rename technical shows for the showcase, for example AQR MAY SHOW 1 to May 1. Technical keys stay unchanged.",
