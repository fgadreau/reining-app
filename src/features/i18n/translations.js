  ...
  fr: {
    ...
    management: {
      ...
      days: {
        ...
        cancel: "Annuler",
        copyClasses: "Copier les classes",
        copyClassesSubmit: "Copier vers cette date",
        copyNoClasses: "Aucune classe à copier dans cette journée.",
        copySameDay: "Choisis une autre date que la journée source.",
        copySuccess: "{{count}} classe(s) copiée(s).",
        ...
        delete: "Supprimer",
        deleteBlocked:
          "Cette journée contient déjà des classes ou des paid warm ups. Elle reste conservée.",
      ...
      scribe: {
        ...
        empty: "Aucune classe avec setup prêt pour le scoring.",
        judges: "Juges",
        loading: "Chargement des classes à scorer...",
        openScoring: "Ouvrir scoring",
        readyClassCount: "{{count}} classe(s) prête(s)",
        runs: "Runs",
  ...
  en: {
    ...
    management: {
      ...
      days: {
        ...
        copyNoClasses: "There are no classes to copy from this day.",
        copySameDay: "Choose a different date than the source day.",
        copySuccess: "{{count}} class(es) copied.",
        ...
        delete: "Delete",
        deleteBlocked:
          "This day already has classes or paid warm ups. It will be kept.",
      ...
      scribe: {
        ...
        empty: "No class has a setup ready for scoring.",
        judges: "Judges",
        loading: "Loading classes to score...",
        openScoring: "Open scoring",
        readyClassCount: "{{count}} ready class(es)",
        runs: "Runs",
