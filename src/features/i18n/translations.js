  ...
  fr: {
    ...
    management: {
      ...
      shows: {
        ...
        publicScheduleHelp:
          "Affiche les départs planifiés des blocs et paid warm ups sur la page publique du show.",
  ...
  en: {
    ...
    management: {
      ...
      shows: {
        ...
        publicScheduleHelp:
          "Shows planned starts for blocks and paid warm ups on the public show page.",
