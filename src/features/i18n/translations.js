  ...
  fr: {
    ...
    management: {
      ...
      shows: {
        ...
        statusLabel: "Statut",
        statusPrefix: "Statut",
        tvDisplayArenaTitle: "Affichage manège sélectionné",
        tvDisplayGeneralTitle: "Affichage manège général",
        tvDisplayHelp:
          "Lien plein écran pour les télévisions du manège. Il montre le live en cours, les prochains, les derniers passés et les commanditaires.",
  ...
  en: {
    ...
    management: {
      ...
      shows: {
        ...
        statusLabel: "Status",
        statusPrefix: "Status",
        tvDisplayArenaTitle: "Selected arena display",
        tvDisplayGeneralTitle: "General arena display",
        tvDisplayHelp:
          "Full-screen link for arena televisions. It shows the current live item, upcoming competitors, recent completed runs, and sponsors.",
