export const publicColors = {
  page: "var(--ss-page, #f5f6f8)",
  surface: "var(--ss-surface, #ffffff)",
  surfaceSoft: "#f8fafc",
  border: "var(--ss-border, #d8dee8)",
  borderStrong: "#b6c2d2",
  text: "var(--ss-text, #101827)",
  muted: "var(--ss-muted, #66758d)",
  softText: "#42526b",
  primary: "var(--ss-primary, #101827)",
  primaryText: "#ffffff",
  blue: "#1d4ed8",
  blueSoft: "#eef5ff",
  green: "#167a4b",
