-- Keep platform-admin checks valid when a Supabase auth user or its linked
-- user_profiles row has been recreated. The email claim comes from the signed
-- Supabase JWT and is matched against the administrator record.
